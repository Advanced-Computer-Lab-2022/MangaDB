...
const incentives = [
  {
    ...
    description:
      "If you are not free at the moment, you can always watch at your own pace",
  },
  {
    name: "Certification",
    imageSrc: "",
    description:
      "Our certificates are approved worldwide and across all platforms",
  },
];
const refund = {
  name: "Refunds",
  description:
    "If you don't like it, You can request a refund and buy a new course instead.",
};
        ...
        <div className="bg-gray-50 rounded-2xl px-6 py-16 sm:p-16">
          <div className="max-w-xl mx-auto lg:max-w-none">
            ...
            <div className="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
              <div
                key={incentives[0].name}
                className="text-center block md:flex lg:block justify-center"
              >
                ...
                <div className="flex justify-center sm:flex-shrink-0">
                  ...
                  >
                    <g>
                      <g>
                        <path
                          d="M503.332,88.293H8.668C3.881,88.293,0,92.174,0,96.961v302.808c0,4.787,3.881,8.668,8.668,8.668h352.294v6.602
			...
			c-1.084,3.34-1.215,6.653-1.328,9.575c-0.061,1.563-0.163,4.151-0.526,4.948C432.081,333.334,429.615,334.239,428.129,334.783z
			 M429.155,391.101v-11.558h41.693l11.558,11.558H429.155z M494.664,378.842l-11.558-11.558V129.446l11.558-11.558V378.842z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M418.157,282.267c-12.738-12.736-33.46-12.736-46.197,0c-12.735,12.736-12.735,33.459,0,46.196
			...
			c3.925,0,7.851,1.494,10.839,4.482C411.876,300.501,411.876,310.227,405.898,316.203z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M333.436,165.746H178.564c-4.787,0-8.668,3.881-8.668,8.668c0,4.787,3.881,8.668,8.668,8.668h154.871
			c4.788,0,8.668-3.881,8.668-8.668C342.104,169.627,338.224,165.746,333.436,165.746z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M309.165,232.78h-106.33c-4.787,0-8.668,3.881-8.668,8.668c0,4.787,3.881,8.668,8.668,8.668h106.33
			c4.788,0,8.668-3.881,8.668-8.668C317.833,236.661,313.953,232.78,309.165,232.78z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M363.485,198.107H148.515c-4.787,0-8.668,3.881-8.668,8.668c0,4.787,3.881,8.668,8.668,8.668h214.971
			c4.788,0,8.668-3.881,8.668-8.668C372.154,201.988,368.274,198.107,363.485,198.107z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M216.704,312.51h-68.19c-4.787,0-8.668,3.881-8.668,8.668c0,4.787,3.881,8.668,8.668,8.668h68.19
              ...
              >
                <div className="flex justify-center sm:flex-shrink-0">
                  <div className="h-[100px] w-[100px] flex justify-center items-center">
                    <img className="h-[80px] w-[80px]" src={money} alt=""></img>
                  </div>
                </div>
                <div className="md:m-auto">
                  <h3 className="text-sm font-medium text-gray-900">
                  ...
                  <p className="text-sm text-gray-500">{refund.description}</p>
                </div>
              </div>
            </div>
          </div>
