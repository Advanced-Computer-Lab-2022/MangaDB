      ...
      <label for={props.label}>
        ...
        <div className="relative">
          <input
            ...
            className={"w-full py-3 border border-slate-200 pl-12 rounded-lg px-3 focus:outline-none focus:border-primaryBlue hover:shadow".concat(props.warning ? " border-red-200" : "")}
